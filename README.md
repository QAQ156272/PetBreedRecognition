...
| 功能 | 描述 |
|------|------|
| 📸 品种识别 | 上传照片自动识别品种，展示 Top-5 预测与置信度 |
| 💬 养护顾问 | 基于大模型生成饮食、护理、健康、训练四维养护建议 |
| 📊 品种对比 | 一键生成两品种多维对比，覆盖体型、性格、饲养难度等 |
| 🏥 健康咨询 | 提供常见健康问题分析与应急参考建议 |

## 可识别品种

共 **37 种**，基于 [Oxford-IIIT Pet Dataset](https://www.robots.ox.ac.uk/~vgg/data/pets/) 训练，并提供中英文品种对照，方便识别与查询。
